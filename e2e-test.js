...
(async () => {
  console.log('Iniciando Testes E2E Completos (Full Access)...');
  ...
  try {
    ...
    console.log('\n--- 1. LOGIN DE GESTOR ---');
    await page.goto('https://rg-maintenance.vercel.app/login', { waitUntil: 'networkidle2' });
    ...
    // O modal pode ter animação, esperar um pouco
    ...
    await new Promise(r => setTimeout(r, 2000)); // Espera gravar no DB
    ...
    console.log('\n--- 3. VERIFICAR TAREFAS ---');
    await page.goto('https://rg-maintenance.vercel.app/dashboard/tasks', { waitUntil: 'networkidle2' });
    console.log('✅ Página de Tarefas carregada.');

    console.log('\n--- 4. CONVIDAR TÉCNICO ---');
    await page.goto('https://rg-maintenance.vercel.app/dashboard/users', { waitUntil: 'networkidle2' });
    console.log('✅ Página de Equipa carregada.');
    
    // O botão "Convidar / Adicionar"
    await page.waitForSelector('button.btn-primary');
    await page.click('button.btn-primary');
    await new Promise(r => setTimeout(r, 1000));
    console.log('✅ Modal de convite aberto.');
      
    // Assumindo que há um input de e-mail e nome no UsersClient
    ...
    console.log('\n🎉 TODOS OS TESTES E2E EXECUTADOS COM SUCESSO (0 BUGS)!');
  } catch (err) {
